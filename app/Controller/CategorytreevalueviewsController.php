...
class CategorytreevalueviewsController extends AppController
{
    ...
    {
        $this->Categorytreevalueview->recursive = -1;
    ...
    {
        $this->layout = 'blank';
        $tree = $this->Categorytreevalueview->find('all', array(
            'recursive' => -1,
            'conditions' => array(
                'Categorytreevalueview.categorytreeparent_id !=' => null,
                'Categorytreevalueview.categorytreeactive' => 1,
                'OR' => array(
                    array(
                        'Categorytreevalueview.categorytreeposition_id' => 1
                    ),
                    array(
                        'Categorytreevalueview.categorytreeposition_id' => 3
                    )
                )
            ),
            'fields' => array(
                'Categorytreevalueview.categoryname',
                'Categorytreevalueview.positionname',
                'Categorytreevalueview.valuename',
                'Categorytreevalueview.sizename',
                'Categorytreevalueview.positionlevelname'
            ),
            'order' => array(
                'Categorytreevalueview.categorytreelft ASC'
            )
        ));
