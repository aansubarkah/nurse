<?php
App::uses('CategorytreesValuesController', 'Controller');

/**
 * CategorytreesValuesController Test Case
 *
 */
class CategorytreesValuesControllerTest extends ControllerTestCase {
