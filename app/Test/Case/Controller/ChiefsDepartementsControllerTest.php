<?php
App::uses('ChiefsDepartementsController', 'Controller');

/**
 * ChiefsDepartementsController Test Case
 *
 */
class ChiefsDepartementsControllerTest extends ControllerTestCase {
