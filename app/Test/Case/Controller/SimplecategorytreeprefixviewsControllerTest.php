<?php
App::uses('SimplecategorytreeprefixviewsController', 'Controller');

/**
 * SimplecategorytreeprefixviewsController Test Case
 *
 */
class SimplecategorytreeprefixviewsControllerTest extends ControllerTestCase {
