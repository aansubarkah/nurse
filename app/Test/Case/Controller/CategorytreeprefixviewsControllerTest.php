<?php
App::uses('CategorytreeprefixviewsController', 'Controller');

/**
 * CategorytreeprefixviewsController Test Case
 *
 */
class CategorytreeprefixviewsControllerTest extends ControllerTestCase {
