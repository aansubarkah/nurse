<?php
App::uses('CategorytreecategoryviewsController', 'Controller');

/**
 * CategorytreecategoryviewsController Test Case
 *
 */
class CategorytreecategoryviewsControllerTest extends ControllerTestCase {
