<?php
App::uses('UsersPositionlevelsController', 'Controller');

/**
 * UsersPositionlevelsController Test Case
 *
 */
class UsersPositionlevelsControllerTest extends ControllerTestCase {
