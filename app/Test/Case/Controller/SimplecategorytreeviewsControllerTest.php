<?php
App::uses('SimplecategorytreeviewsController', 'Controller');

/**
 * SimplecategorytreeviewsController Test Case
 *
 */
class SimplecategorytreeviewsControllerTest extends ControllerTestCase {
