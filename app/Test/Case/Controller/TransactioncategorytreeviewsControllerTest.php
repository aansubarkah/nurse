<?php
App::uses('TransactioncategorytreeviewsController', 'Controller');

/**
 * TransactioncategorytreeviewsController Test Case
 *
 */
class TransactioncategorytreeviewsControllerTest extends ControllerTestCase {
