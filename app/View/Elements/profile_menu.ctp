...
$arrMenu[0]['action'] = '/';
$arrMenu[1]['title'] = 'Pangkat/Golongan';
$arrMenu[1]['action'] = 'level';
$arrMenu[2]['title'] = 'Jabatan';
$arrMenu[2]['action'] = 'positionlevel';
...
<div class="col-md-4">
    <div class="list-group">
        ...
        for ($i = 0; $i < $countArrMenu; $i++) {
            ...
            if ($i == 1 && $currentController == 'users' && $currentAction == 'level') $menuClass .= ' disabled';
            if ($i == 2 && $currentController == 'users' && $currentAction == 'positionlevel') $menuClass .= ' disabled';
